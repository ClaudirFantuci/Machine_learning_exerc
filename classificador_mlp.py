...
def executar():
    ...
    for i, seed in enumerate(SEEDS, start=1):
        ...
        # MLP exige normalização para convergir corretamente
        scaler   = StandardScaler()
        X_treino = scaler.fit_transform(X_treino)
        X_teste  = scaler.transform(X_teste)

        modelo = MLPClassifier(hidden_layer_sizes=(100, 50), max_iter=500, random_state=0)
    ...
    df_res.to_csv("resultado_mlp.csv", index=False)
    ...
    print(f"  Resultados salvos em: resultado_mlp.csv")